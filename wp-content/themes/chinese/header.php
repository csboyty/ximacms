...
<head>
    ...
    <meta name="keywords" content="湖南西玛">
    <meta name="description" content="湖南西玛">
...
<div class="header">
    ...
    <form role="search" method="get" id="searchform" class="search" action="<?php echo home_url(); ?>">
        <input class="input" type="text" name="s" placeholder="搜索...">
        <input type="hidden" name="cat" value="1" />
        <input type="submit" id="searchsubmit" class="btn" value="搜索" />
    </form>
